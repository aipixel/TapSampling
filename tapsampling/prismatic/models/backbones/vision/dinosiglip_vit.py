...
TAPSAMPLING_ROOT = Path(__file__).resolve().parents[4]
PRETRAINED_MODELS_ROOT = TAPSAMPLING_ROOT / "pretrained_models"
DINO_LOCAL_WEIGHT_PATH = PRETRAINED_MODELS_ROOT / "vit_large_patch14_reg4_dinov2.lvd142m" / "pytorch_model.bin"
SIGLIP_LOCAL_WEIGHT_PATH = PRETRAINED_MODELS_ROOT / "ViT-SO400M-14-SigLip" / "open_clip_pytorch_model.bin"
...
class DinoSigLIPViTBackbone(VisionBackbone):
    def __init__(
        ...
        self.siglip_featurizer: VisionTransformer = timm.create_model(
            ...
            pretrained_cfg={
                'file': str(SIGLIP_LOCAL_WEIGHT_PATH)
            }
        )
